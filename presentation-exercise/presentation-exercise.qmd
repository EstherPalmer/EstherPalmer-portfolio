...
```
Wait these axis labels do not match the data
...
```
So by removing the geom_stratum line I can keeo the data labels correct, which is fine, just further away from the original graph. I have solved the flipped y axis being weird by flipping the positions of all my variables.